...
public class SerilogRequestUtility
{
      ...
      public static LogEventLevel GetRequestLevel(HttpContext ctx, double _, Exception? ex) => ex is null && ctx.Response.StatusCode <= 499 ? IgnoreRequest(ctx) : LogEventLevel.Error;
